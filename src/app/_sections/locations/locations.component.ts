...
export class LocationsComponent {
  public readonly locations_1: string[] = ['Moldova', 'Ukraine', 'Nepal', 'Malaysia', 'India', 'Portugal', 'Hungary'];
  public readonly locations_2: string[] = ['Vietnam', 'Kazakhstan', 'Kyrgyzstan', 'Philippines', 'Dubai', 'Colombia'];
